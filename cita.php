...
@media (max-width:768px){header{flex-direction:column;align-items:center;text-align:center;padding:15px;}.logo-area{flex-direction:column;margin-bottom:15px;}.logo-area img{height:60px;margin:0 0 10px 0;}nav{display:flex;flex-direction:column;gap:10px;}nav a{margin:0;font-size:16px;}nav{display:none;flex-direction:column;position:absolute;top:100%;left:0;width:100%;background:#6EDC5A;padding:20px 0;text-align:center;}nav a{margin:15px 0;display:block;font-size:18px;}.menu-toggle{display:block;}}
</style>
</head>
<body>
<header>
...
<div class="estado"><?php echo $mensaje_estado; ?></div>
</form>
</div>
<div class="volver">
